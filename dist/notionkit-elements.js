var NotionKitElements = (function (exports) {
  ...
  // NotionKit v1.15.0 – Constructable Stylesheet
...
`);
  ...
  floatSheet$1.replaceSync(`:host([floating]) { display: block; position: fixed; top: 0; left: 0; z-index: 60; pointer-events: none; }`);
