...
`);
  ...
  floatSheet$1.replaceSync(`:host([floating]) { display: block; position: fixed; top: 0; left: 0; z-index: 106; pointer-events: none; }`);
  ...
  const CLOSE_ICON$1 = '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="m6 17 5-5-5-5M13 17l5-5-5-5"/></svg>';
  ...
  class NkPeek extends NkElement {
    ...
    render() {
      ...
      this._close.innerHTML = CLOSE_ICON$1;
...
`);
  ...
  exports.NkGalleryView = NkGalleryView;
  ...
  exports.builtInStrings = builtInStrings;
